...
//    SQL_BASE_DIR  = "meister_sql/",
    ...
    SIGN_COMPETITION    = "Competition",
    SIGN_RATING         = "Rating",
    SIGN_CLASS          = "Class",
    SIGN_COMPETITOR     = "Competitor",
    SIGN_TEAM           = "Team",
    SIGN_TEAM_MEMBER    = "TeamMember",
    SIGN_REGISTRATION   = "Registration",
    SIGN_LIST           = "List",

    SIGN_PROJECTOR      = "Projector",
    SIGN_ATHLETE        = "Athlete",
    SIGN_CLUB           = "Club",
    SIGN_USER           = "User",
    SIGN_GRP            = "Group",
    SIGN_DATA           = "Data",
...
var DEFAULT_LANG  = get_lang(),
    ...
    TEMP_BASE = {
      'class':       'CREATE TABLE "class" ("id" INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL , "sex" CHAR DEFAULT M, "name" VARCHAR, "type" VARCHAR, "val" BLOB, "r" INTEGER, "bscores" INTEGER, "tscores" INTEGER, "formula" VARCHAR DEFAULT "12-2*R")',
      'competitor':  'CREATE TABLE "competitor" ("id" INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL , "class_id" INTEGER DEFAULT 0, "team_id" INTEGER DEFAULT 0, "forename" VARCHAR, "surename" VARCHAR, "birthday" DATETIME, "club" VARCHAR, "valid" BOOL, "nr" INTEGER DEFAULT 0, "squad" INTEGER DEFAULT 0, "val" BLOB, "stmp" DATETIME, "r" VARCHAR, "s" VARCHAR, UNIQUE (surename,forename,birthday,class_id) ON CONFLICT REPLACE)',
      'team':        'CREATE TABLE "team" ("id" INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL , "name" VARCHAR, "class_id" INTEGER, "valid" VARCHAR, "nr" INTEGER DEFAULT 0, "squad" INTEGER DEFAULT 0, "email" VARCHAR, UNIQUE ("name", "class_id") ON CONFLICT REPLACE)',
      'registration':'CREATE TABLE "registration" ("id" INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL , "datum" DATETIME DEFAULT CURRENT_TIMESTAMP, "valid" BOOL, "class_id" INTEGER, "team" VARCHAR, "email" VARCHAR, "judge" VARCHAR, "message" TEXT, "val" BLOB)',
      'list':        'CREATE TABLE "list" ("id" INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL , "name" VARCHAR, "val" TEXT)'
    },
...
// login page
function login_init(){
  $("a", "#id_Login_Tab").each(function(){
    var href = $(this).prop("href");
    if(href.match(/\.htm$/))
      $(this).prop("href", href+window.route);
  });
  // miso_kruhy --------------------------------------------------------
